...
function draw() {
      ...
      img.addEventListener('load', function() {
            context.drawImage(img, 0, 0, (5/7) * referenceWidth, (5/7) * referenceHeight);
            ...
            function redraw() {
                  context.fillStyle = 'rgb(58,53,50)';
                  context.strokeStyle = 'rgb(58,53,50)';
                  var r = Math.random() * 1;
                  context.fillStyle = 'white';
                  context.beginPath();
                  context.arc(105, 105, r, 0, 2*Math.PI);
                  context.stroke();
                  context.fill();
                  var r = Math.random() * 1;
                  context.beginPath();
                  context.arc(705, 130, r, 0, 2*Math.PI);
                  context.stroke();
                  context.fill();
                  var r = Math.random() * 1;
                  context.beginPath();
                  context.arc(410, 90, r, 0, 2*Math.PI);
                  context.stroke();
                  context.fill();
                  var r = Math.random() * 1;
                  context.beginPath();
                  context.arc(230, 200, r, 0, 2*Math.PI);
                  context.stroke();
                  context.fill();
                  var r = Math.random() * 1;
                  context.beginPath();
                  context.arc(30, 170, r, 0, 2*Math.PI);
                  context.stroke();
                  context.fill();
                  var r = Math.random() * 1;
                  context.beginPath();
                  context.arc(520, 20, r, 0, 2*Math.PI);
                  context.stroke();
                  context.fill();
                  var r = Math.random() * .1;
                  context.beginPath();
                  context.arc(180, 30, r, 0, 2*Math.PI);
                  context.stroke();
                  context.fill();
                  var r = Math.random() * 1;
                  context.beginPath();
                  context.arc(650, 80, r, 0, 2*Math.PI);
                  context.stroke();
                  context.fill();
                  var r = Math.random() * 1;
                  context.beginPath();
                  context.arc(800, 40, r, 0, 2*Math.PI);
                  context.stroke();
                  context.fill();
                  var r = Math.random() * 1;
                  context.beginPath();
                  context.arc(250, 110, r, 0, 2*Math.PI);
                  context.stroke();
                  context.fill();
                  var r = Math.random() * 1;
                  context.beginPath();
                  context.arc(200, 245, r, 0, 2*Math.PI);
                  context.stroke();
                  context.fill();
                  var r = Math.random() * 1;
                  context.beginPath();
                  context.arc(90, 230, r, 0, 2*Math.PI);
                  context.stroke();
                  context.fill();
                  var r = Math.random() * 1;
                  context.beginPath();
                  context.arc(420, 250, r, 0, 2*Math.PI);
                  context.stroke();
                  context.fill();
                  var r = Math.random() * 1;
                  context.beginPath();
                  context.arc(770, 155, r, 0, 2*Math.PI);
                  context.stroke();
                  context.fill();
                  var r = Math.random() * 1;
                  context.beginPath();
                  context.arc(20, 30, r, 0, 2*Math.PI);
                  context.stroke();
                  context.fill();
